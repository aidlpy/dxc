//
//  OrderAllCommentsViewController.m
//  duxin
//
//  Created by Zhang Xinrong on 08/03/2018.
...
@interface OrderAllCommentsViewController ()<UITableViewDelegate,UITableViewDataSource>{
    UITableView *_tableView;
    NSMutableArray *_dataArray;
}
@end

@implementation OrderAllCommentsViewController
...
-(void)fetchData
{
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@%@",FetchAllOrderComment,_orderId];
        ...
        dispatch_async(dispatch_get_global_queue(0, 0), ^{
            ...
            if ([[responseObject objectForKey:@"code"] integerValue] ==200) {
                ...
                if ([[dataDic objectForKey:@"error_code"] integerValue] == 0) {
                    NSArray *modelArray = [CommentModel transferAllCommentModels:commentArray];
